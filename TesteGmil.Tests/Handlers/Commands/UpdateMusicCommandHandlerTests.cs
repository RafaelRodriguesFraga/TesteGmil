    ...
    public class UpdateMusicCommandHandlerTests
    {
        ...
        public async Task Given_ValidMusic_ReturnsCorrectResult()
        {
            ...
            using (var context = new TestGmilContext(options))
            {
                ...
                var command = new UpdateMusicCommand { Id = existingMusic.Id, Title = "Updated Music" };

                var mapperMock = new Mock<IMapper>();
                var handler = new UpdateMusicCommandHandler(context, mapperMock.Object);
        ...
        public async Task Given_MusicNotFound_ReturnsErrorResult()
        {
            ...
            using (var context = new TestGmilContext(options))
            {
                ...
                var command = new UpdateMusicCommand { Id = Guid.NewGuid(), Title = "Updated Music" };
